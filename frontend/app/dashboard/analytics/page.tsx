        ...
        <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-zinc-500 ml-14">
              Deep dive into your agent performance and costs.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-lg p-1 shadow-sm dark:shadow-none">
              ...
              >
                <option value={7} className="bg-white dark:bg-[#111]">
                  Last 7 days
                </option>
                <option value={14} className="bg-white dark:bg-[#111]">
                  Last 14 days
                </option>
                <option value={30} className="bg-white dark:bg-[#111]">
                  Last 30 days
                </option>
              </select>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-black/5 dark:border-white/5">
                    <th className="text-left px-6 py-3 text-xs text-zinc-600 dark:text-zinc-500 font-medium">
                      Model
                    </th>
                    <th className="text-right px-6 py-3 text-xs text-zinc-600 dark:text-zinc-500 font-medium">
                      Calls
                    </th>
                    <th className="text-right px-6 py-3 text-xs text-zinc-600 dark:text-zinc-500 font-medium">
                      Total Tokens
                ...
                <tbody className="divide-y divide-black/5 dark:divide-white/5">
                  {data.modelUsage.map((m) => (
                    ...
                    >
                      <td className="px-6 py-3 text-zinc-900 dark:text-white font-medium">
                        {m.model}
                      </td>
                      ...
                      <td className="px-6 py-3 text-right text-zinc-600 dark:text-zinc-400">
                        {m.count > 0
                          ? Math.round(m.tokens / m.count).toLocaleString()
                          : "—"}
                      </td>
                    </tr>
                  ))}
